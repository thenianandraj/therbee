    ...
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                ...
                </span>Available Product List
            </h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Available Product List</li>
                </ol>
            </nav>
        </div>
        <div class="form">
        ...
        <div class="row">
            <div style="text-align: right;">
                <h3 class="page-title">
                    <a class="nav-link" href="device_create">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($images as $key=>$product)
                                            <tr>
                                                ...
                                                <td>{{$product->type}}</td>
                                                <td>
                                                    <a href="/devices_edit{{$product->id}}" class="mdi mdi-lead-pencil"
                                                        style="font-size: 24px;"></a>
                                                    <a href="/devices_delete{{$product->id}}" class="mdi mdi-delete"
                                    ...
                                    <tr>
                                        <td class="table-paginate" colspan="3">{{ $images->links() }}</td>
                                    </tr>
                                </table>
                            </div>
